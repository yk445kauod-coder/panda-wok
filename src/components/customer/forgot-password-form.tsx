    ...
    <form onSubmit={onSubmit} noValidate className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="h-11 w-full rounded-xl border border-ink-900/12 bg-rice-50 px-3.5 text-base text-ink-900 outline-none transition focus:border-vermilion-500 focus:ring-2 focus:ring-vermilion-500/20"
        />
        {fields.identifier ? (
