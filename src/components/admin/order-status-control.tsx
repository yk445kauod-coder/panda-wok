      ...
      <div className="flex items-center gap-1.5">
        {options.slice(0, 2).map((status) => (
          <button
            ...
            className="rounded-lg bg-plum-600 px-2.5 py-1.5 text-xs font-medium text-rice-50 hover:bg-plum-700 disabled:opacity-60"
          >
                ...
                <button
                  ...
                  className={
                    destructive
                      ...
                      : "rounded-lg bg-plum-600 px-3 py-2 text-xs font-medium text-rice-50 hover:bg-plum-700 disabled:opacity-60"
                  }
                >
